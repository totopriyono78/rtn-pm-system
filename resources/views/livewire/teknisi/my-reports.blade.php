<div class="space-y-6">
    <x-page-header icon="clipboard-list" color="emerald" title="Riwayat Laporan Saya" />
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left text-sm">
                ...
                <tbody>
                        ...
                        <tr class="border-t border-slate-100 transition-colors hover:bg-slate-50/70">
                            ...
                            <td class="py-2">
                                @forelse ($report->files as $file)
                                    <a href="{{ route('reports.files.show', $file) }}" class="mr-2 inline-flex items-center gap-1 text-indigo-600 hover:underline">
                    ...
                    @empty
                        <tr><td colspan="6"><x-empty-state icon="clipboard-list" title="Belum ada laporan." /></td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
